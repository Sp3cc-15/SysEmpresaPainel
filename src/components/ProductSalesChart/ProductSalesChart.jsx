...
const ProductSalesChart = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:3000/api/porproduto', dataToSend, {
        headers: {
      ...
      setProductSalesData(parsedData);
    } catch (error) {
  ...
  const prepareChartData = () => {
    ...
    const categories = sortedData.map(item => item.Produto);
          ...
          {!isDataGridOpen ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
              ...
              >
                ...
                <Column dataField="CODPRODUTO" caption="Código" visible={false} />
                <Column dataField="Produto" caption="Produto" />
